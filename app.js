...
app.use(function(req, res, next) {
  ...
  res.setHeader("Content-Security-Policy", "script-src 'self' https://apis.google.com; frame-src 'none'; default-src 'self' https://gravatar.com http://themes.googleusercontent.com http://fonts.googleapis.com; style-src 'self' http://fonts.googleapis.com");
